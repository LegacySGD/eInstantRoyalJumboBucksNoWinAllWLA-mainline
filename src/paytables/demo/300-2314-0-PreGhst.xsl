			...
			<lxslt:component prefix="my-ext" functions="formatJson,retrievePrizeTable,getType">
				<lxslt:script lang="javascript">
					...
					function formatJson(jsonContext, translations, prizeTable, prizeValues, prizeNamesDesc)
					{
						...
						var outcomeBonuses = getOutcomeData(scenario, 2);
						...
						r.push('<tr>'); 
 						...
 						r.push(getTranslationByName("prizeValue", translations));
						r.push('</td>');
						r.push('<td class="tablehead" width="25%">');
 						r.push(getTranslationByName("bonusKeys", translations));
						r.push('</td>');
 						r.push('</tr>');
						...
						r.push('<tr>');
 						r.push('<td class="tablehead" width="25%">');
 						r.push(getTranslationByName("bonusKeysTotal", translations));
 						r.push('</td>');
						r.push('<td class="tablehead" width="25%">');
